...
class Module:
    ...
    def __getattr__(self, name):
        """
        Redirect calls to methods ending with '_module' when accessed without '_module'.
        """
    ...
    def es_primo_module(self, n: int) -> bool:
        ...
        if n <= 2047:
            ...
            bases = [2, 3]
        elif n < 14386156093:  # https://hp41programs.yolasite.com/primes.php
            bases = [2, 3, 5]
        elif n < 2**64:  # https://oeis.org/A014233
    ...
    def factorizar_module(self, n: int) -> dict[int, int]:
        ...
        if n < 10**10:
            ...
            while seed < 6:
                ...
                seed += 1
            # If all seeds failed, use the simple factorization method
            return {**factors, **self.factorizar_simple_module(n)}
